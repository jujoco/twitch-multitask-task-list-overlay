...
const _userConfig = {
	...
	responseTo: {
		...
		ES: {
			...
			maxTasksAdded: 'Número máximo de tareas alcanzado, intenta eliminar tareas antiguas.',
		...
		FR: {
			...
			maxTasksAdded: 'Nombre maximum de tâches atteint, essayez de supprimer les anciennes tâches.',
			noTaskFound: "Cette tâche ne semble pas exister, essayez d'en ajouter une!",
		...
		JP: {
			...
			maxTasksAdded: '最大タスク数に達しました、古いタスクを削除してみてください。',
		...
		UA: {
			...
			additional: 'Jujoco створив цей бот, глянь його стрім : https://www.twitch.tv/Jujoco_Dev',
			maxTasksAdded: 'Додано максимальну кількість завдань. Спробуй видалити щось старе.',
		...
		DE: {
			...
			maxTasksAdded: 'Maximale Anzahl an Aufgaben erreicht, versuche alte Aufgaben zu löschen.',
		...
		PT_BR: {
			...
			maxTasksAdded: 'Número máximo de tarefas atingido, tente deletar tarefas antigas.',
